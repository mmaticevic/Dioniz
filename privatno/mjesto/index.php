...
$izraz = $veza -> prepare("SELECT count(id) from mjesto where naselje like :pretraga;");
		...
		<div class="row">
			...
			<div class="col-sm-9 padding-right">
				<div class="features_items"><!--features_items-->
					...
					$izraz = $veza -> prepare("
						SELECT * from mjesto where naselje like :pretraga limit :odKuda,:poStranici
						...
						<tbody>
							...
							<?php foreach ($niz as $mjesto): ?>
								...
								<tr>
									...
									<td><a href="brisanje.php?id=<?php echo $mjesto->id ?>" class="btn btn-danger btn-block "><i class="fa fa-eraser" aria-hidden="true"></i></a></td>
									<td><a href="promjena.php?id=<?php echo $mjesto->id ?>" class="btn btn-info btn-block "><i class="fa fa-refresh" aria-hidden="true"></i></a></td>
								</tr>
